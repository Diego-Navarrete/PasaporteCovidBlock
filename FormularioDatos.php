...
//recuerde que el crea un array segun la consulta devuelta, con los mismos nombres si señor y ahora me trae toda la base de datos 
...
FROM  registro where NUMERO_DOCUMENTO='$Numero'"; //coloque el parametro ?? pregunta seria el mismo parametro del cargue ejemplo 
//ese formulario debe ser llamdo con un parametro por que es distinto al de carga o es el de regreso? este formulario es el rsultado de la consulta 
        ...
        <div class="u-align-center u-form u-form-1">
            <div class="u-form-group u-form-partition-factor-2 u-form-select u-form-group-1">
              ...
              <div class="u-form-select-wrapper">
                <input id="select-faf0" name="Tipod" value="<?php echo $GET["TIPO_DOCUMENTO"];?>" class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base" required="required">
                </div>
            </div>
              ...
              <input type="text" placeholder="" id="name-6797" name="numero" value="<?php echo $GET["NUMERO_DOCUMENTO"];?>" class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base" required="">
            </div>
            <div class="u-form-group u-form-name u-form-group-3">
              ...
              <input type="text" placeholder="" id="name-9de0" name="nombreapellido" value="<?php echo $GET["NOMBE_APELLIDO"];?>" class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base" required="">
            </div>
            <div class="u-form-address u-form-group u-form-partition-factor-2 u-form-group-4">
              ...
              <input type="text" placeholder="" id="address-09a7" name="ciudad" value="<?php echo $GET["CIUDAD"];?>" class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base" required="">
            </div>
            <div class="u-form-group u-form-partition-factor-2 u-form-select u-form-group-5">
              ...
              <div class="u-form-select-wrapper">
                <input id="select-eaf3" name="regimen" value="<?php echo $GET["REGIMEN"];?>" class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base" required="required">
                 </div>
            </div>
            <div class="u-form-group u-form-name u-form-partition-factor-2 u-form-group-6">
              ...
              <input type="text" placeholder="" id="name-00c0" name="eps" value="<?php echo $GET["EPS"];?>" class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base" required="">
            </div>
            <div class="u-form-group u-form-name u-form-partition-factor-2 u-form-group-7">
              ...
              <input type="text" placeholder="" id="name-1d57" name="centroa" value="<?php echo $GET["CENTRO_ATENCION"];?>" class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base" required="">
            </div>
            <div class="u-form-group u-form-partition-factor-2 u-form-select u-form-group-8">
              ...
              <div class="u-form-select-wrapper">
                <input id="select-3692" name="" value="<?php echo $GET["RESULTADO"];?>" class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base" required="required">
                  </div>
            </div>
            <div class="u-form-date u-form-group u-form-partition-factor-2 u-form-group-9">
              ...
              <input type="text" placeholder="MM/DD/YYYY" id="date" name="fechap" value="<?php echo $GET["FECHA_PRUEBA"];?>" class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base" required="">
            </div>
            <div class="u-form-group u-form-partition-factor-2 u-form-select u-form-group-10">
              ...
              <div class="u-form-select-wrapper">
                <input id="select-09e6" name="" value="<?php echo $GET["TIPO_VACUNA"];?>" class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base" required="required">
            ...
            <div class="u-form-group u-form-name u-form-partition-factor-2 u-form-group-11">
              ...
              <input type="text" placeholder="lugar" id="name-cb67" name="lugar" value="<?php echo $GET["LUGAR_VACUNACION"];?>" class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base" required="">
            </div>
            <div class="u-form-date u-form-group u-form-partition-factor-2 u-form-group-12">
              ...
              <input type="text" placeholder="MM/DD/YYYY" id="date" name="FechaP" value="<?php echo $GET["FECHA_PRIMERA_DOSIS"];?>" class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base" required="">
            </div>
            <div class="u-form-date u-form-group u-form-partition-factor-2 u-form-group-13">
              <label for="date  " class="u-custom-font u-font-open-sans u-label u-text-palette-1-light-1">Fecha Segunda Dosis</label>
              <input type="text" placeholder="MM/DD/YYYY" id="date" name="FechaS" value="<?php echo $GET["FECHA_SEGUNDA_DOSIS"];?>" class="u-border-1 u-border-palette-1-base u-input u-input-rectangle u-text-palette-1-base" required="">
            </div>
             </form>   
        </div>
        <a href="Consultas.php" data-page-id="359922106" class="u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-50 u-btn-1">CONSULTAR OTRO USUARIO</a>
        <a href="index.html" data-page-id="359922106" class="u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-50 u-btn-1">REGRESAR</a>
    </form>
    </section>
